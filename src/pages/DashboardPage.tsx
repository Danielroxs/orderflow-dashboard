...
export const DashboardPage = () => {
  ...
  if (orders.length === 0) {
    return (
      <div>
        ...
        <EmptyState
          title="No Orders Yet"
          message="Start by creating your first order to see metrics here"
        />
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      {/* Metrics Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-6 mt-6 lg:mt-8">
